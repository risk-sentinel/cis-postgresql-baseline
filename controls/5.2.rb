...
control 'C-5.2' do
  ...
  describe 'AWS shared-responsibility inheritance' do
    it 'is satisfied by AWS-managed controls — control is satisfied by AWS under the shared-responsibility model. AWS configures Aurora\'s network listen address on its managed ENI. Customer-facing exposure is governed by security groups + publicly_accessible (covered by cis-aws-database CIS 2.9 / 3.12) (evidence: AWS SOC 2 Type II, AWS FedRAMP Moderate, AWS FedRAMP High, AWS ISO 27001; AWS Artifact: https://console.aws.amazon.com/artifact/)' do
